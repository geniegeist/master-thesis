\chapter{Invertibility Criterion}
...
Let us demonstrate this division with an example.
...
\begin{example}
    We continue Example \ref{ex:decomposition-nsjkfnje}. Choose \( \lambda = (2,1,1,1,1,1) \) and we obtain 
    \begin{gather*}
