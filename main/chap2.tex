...
We will now spend the rest of this thesis on proving Proposition \ref{prop:degree-fundamental-models}. Let us lay the groundwork for this proof now, so that we can introduce a combinatorial approach to counting the number of fundamental models in the next chapters.spaopdasodasokp