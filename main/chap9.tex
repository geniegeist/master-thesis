...
\begin{definition}
    ...
    \end{align*}
    with the map \( \chi: H^\Xi \to H^{\Xi'}, \mathbf{s} = (\mathbf{x}, \mathbf{y}, \mathbf{z}, \mathbf{b}, \mathbf{c}, \mathbf{d}, \mathbf{e}) \mapsto (\mathbf{x}, \mathbf{y}, \mathbf{z}, \mathbf{b}, \mathbf{c}, \underbracket{\mathbf{d} + \mathbf{e}}_{\coloneqq \mathbf{f}}) \). The new coordinate system \( H^{\Xi'} \) is visualized below.
\begin{figure}[H]
    \begin{align*}
