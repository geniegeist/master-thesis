...
We use symmetry to reduce the number of cases further. Let \( \mathbf{s}' \in \Lambda \) be one of the 1107 cases. We apply the following symmetries to \( \mathbf{s}' \) similar to the symmetries in Section \ref{sec:symmetry}:
\begin{align*}
