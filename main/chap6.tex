...
We introduce the \emph{Hyperfield Criterion} and \emph{Contractions}, along with the \emph{Invertibility Criterion}, to prove the degree bound of valid outcomes. These criteria can be interpreted as constraints on the support of valid outcomes.
